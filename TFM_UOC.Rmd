...
p1 <- DimPlot(seurat, reduction = "umap", group.by = "patient_id", label = T, label.box = T) + theme(aspect.ratio=1)
p2 <- DimPlot(seurat, reduction = "umap", group.by = "treatment_phase", label = T, label.box = T) + theme(aspect.ratio=1)
p1|p2
```
